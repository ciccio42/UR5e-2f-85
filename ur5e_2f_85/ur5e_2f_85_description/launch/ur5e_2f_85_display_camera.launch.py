    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution(
                [FindPackageShare("ur5e_2f_85_description"), "urdf", "ur5e_2f_85_platform_control.urdf.xacro"]
            ),
            description="URDF/XACRO description file (absolute path) with the robot. Defaults to "
            "the *_control variant, which is the one that includes the ZED Mini camera macro.",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
