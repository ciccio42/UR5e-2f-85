...
def launch_setup(context, *args, **kwargs):
    ...
    aruco_localization_dir = get_package_share_directory('zed_aruco_localization')
    ...
    # Change detection on left frame
    zed_aruco_component = ComposableNode(
        ...
        remappings=[
                ('in/zed_image', zed_node_name_val + '/left/color/rect/image'), #'/rgb/color/rect/image'),
                ('in/camera_info', zed_node_name_val + '/left/color/rect/camera_info'), #'/rgb/color/rect/camera_info'),
    ...
    container = ComposableNodeContainer(
            name='zed_camera_calibration_container',
            namespace=camera_name_val,
