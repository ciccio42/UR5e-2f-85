from .savers import trajectory as _trajectory_module
from .savers.trajectory import Trajectory
...
import sys
sys.modules.setdefault('trajectory', _trajectory_module)
try:
    raise NotImplementedError
    from .savers.render_loader import ImageRenderWrapper
...
def load_traj(fname):
    if '.pkl' in fname:
        ...
        from .savers.hdf5_trajectory import HDF5Trajectory
        traj = HDF5Trajectory()
        traj.load(fname)
    else:
        raise NotImplementedError
