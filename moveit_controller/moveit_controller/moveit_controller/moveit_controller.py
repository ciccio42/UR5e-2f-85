...
class MoveItControllerNode(Node):
    ...
    def _switch_controllers(self, controller_to_run, controller_to_stop):
        ...
        future_controller_state = self.client_controller_state.call(client_controller_state_request)
        # rclpy.spin_until_future_complete(self, future_controller_state)
        controllers = future_controller_state.controller
        ...
        future_switch = self.client_switch.call(request_switch) 
